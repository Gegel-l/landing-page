import {HERO_CONTENT} from "../assets/vastu-spaze-assets-main/constants/index.js";
    ...
    return (
        <section className="max-w-7xl mx-auto border-b-2">
            <div className="flex flex-col items-center my-20">
                ...
                <img src={HERO_CONTENT.image} className="w-full h-[65vh] object-cover rounded-2xl p-2" alt="image"/>
            </div>
        </section>
    )
}
