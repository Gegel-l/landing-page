import {SERVICES_CONTENT} from "../assets/vastu-spaze-assets-main/constants/index.js";
                ...
                {SERVICES_CONTENT.map((service, index) => (
                    <div key={index} className="mb-12 mx-4 flex flex-col lg:flex-row">
                        <div className={`lg:w-1/2 mb-4 lg:mb-0 ${
                            ...
                            <img src={service.image} className="w-full h-auto object-cover rounded-lg" alt={service.title}/>
                        </div>
